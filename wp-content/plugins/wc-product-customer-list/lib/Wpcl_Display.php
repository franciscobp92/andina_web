...
class Wpcl_Display
{
    ...
    public function render_meta_box()
    {
        ...
        if ( count( $order_items ) > 0 ) {
            ...
            echo  sprintf( wp_kses( __( 'This product currently has no customers. By default, the plugin only displays orders with a "complete" status. You can change this in the <a href="%s" target="_blank">plugin settings</a>.', 'wc-product-customer-list' ), array(
                'a' => array(
                'href'   => array(),
                'target' => '_blank',
            ),

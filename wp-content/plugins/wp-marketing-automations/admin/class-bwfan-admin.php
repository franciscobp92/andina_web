...
class BWFAN_Admin {
	...
	/**
	 * Removing the script from Autonami plugin pages
	 *
	 * @return void
	 */
	...
	public function register_admin_menu() {
		...
		add_menu_page( false, __( 'Autonami', 'wp-marketing-automations' ), $capability, 'autonami', array( $this, 'autonami_page' ), '', 59 );
		...
		add_submenu_page( 'autonami', 'Automations', $title, $capability, 'autonami-automations', array( $this, 'autonami_automations_page' ), 25 );
		...
		if ( false === bwfan_is_autonami_pro_active() ) {
			...
			], "https://buildwoofunnels.com/wordpress-marketing-automation-autonami/" );
	...
	public function maybe_set_as_ct_worker() {
		if ( ! BWFAN_Common::bwf_has_action_scheduled( 'bwfan_run_queue' ) ) {

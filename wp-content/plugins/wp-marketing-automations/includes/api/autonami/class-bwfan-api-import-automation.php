...
class BWFAN_API_Import_Automations extends BWFAN_API_Base {
	...
	public function process_api_call() {
		...
		$automation_id = BWFAN_Core()->automations->import( $import_file_data );
		$this->response_code = 200;

		return $this->success_response( [ 'automation_id' => $automation_id ], __( 'Automation Imported Successfully.', 'wp-marketing-automations' ) );
	}

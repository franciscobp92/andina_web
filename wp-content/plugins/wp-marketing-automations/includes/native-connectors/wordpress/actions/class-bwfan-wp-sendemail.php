...
//				$this->data['body']     = BWFAN_Common::decode_merge_tags( $this->data['body'] );
	...
	public function append_to_email_body( $body, $pre_header ) {
		...
		$pre_header    = '<span class="preheader" style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">' . $pre_header . '</span>';
		$appended_body = $body;

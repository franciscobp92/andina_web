...
class BWFAN_API_Delete_Abandoned_Carts extends BWFAN_API_Base {
	...
	public function process_api_call() {
		...
		if ( empty( $abandoned_ids ) || ! is_array( $abandoned_ids ) ) {
			return $this->error_response( __( 'Abandoned ids is missing.', 'wp-marketing-automations' ) );
		}
		...
		return $this->success_response( [], __( 'Cart abandoned deleted successfully.', 'wp-marketing-automations' ) );
	}
}

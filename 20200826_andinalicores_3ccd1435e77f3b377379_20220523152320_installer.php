...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200826_andinalicores_3ccd1435e77f3b377379_20220523152320_archive.zip';
	const ARCHIVE_SIZE		 = '572607387';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3ccd143-23152320';
    const SECONDARY_PACKAGE_HASH = '3632ab9-23152320';
	const VERSION			 = '1.4.6';

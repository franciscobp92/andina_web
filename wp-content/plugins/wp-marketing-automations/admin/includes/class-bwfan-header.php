...
//		}
	...
	public function get_render_data() {
		return array(
			'logo'               => esc_url( plugin_dir_url( BWFAN_PLUGIN_FILE ) . 'admin/assets/img/menu/logo.svg' ),
                ...
                <div class="bwfan_header_l">
                    <div>
                        <a class="bwf-breadcrumb-svg-icon" href="<?php echo admin_url( 'admin.php?page=autonami' ); ?>">
                            <img src="<?php echo esc_url( plugin_dir_url( BWFAN_PLUGIN_FILE ) . 'admin/assets/img/menu/logo.svg' ); ?>"/>
                        </a>
                    </div>

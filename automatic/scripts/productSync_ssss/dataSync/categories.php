<?php
    ...
    function custom_logs_categories($message) { 
        if(is_array($message)) { 
            $message = json_encode($message); 
        } 
        $file = fopen("./categories_log.log","a"); 
    ...
    function CategoriesSync($URLServices,$client)
    {
        ...
        custom_logs_categories("---Inicia sync categorias---");
        ...
        custom_logs_categories($productData);
        ...
        foreach($productData as $valueProduct){
            foreach($valueProduct as $product){
                custom_logs_categories("Secciones y sub secciones");

...
class BWFAN_API_Get_Recent_Recovered extends BWFAN_API_Base {
	...
	public function process_api_call() {
		...
		if ( empty( $recovered_carts ) ) {
			...
			return $this->success_response( [], __( 'Got all recovered carts.', 'wp-marketing-automations' ) );
		}
		...
		return $this->success_response( $result, __( 'Got all recovered carts.', 'wp-marketing-automations' ) );
	}
